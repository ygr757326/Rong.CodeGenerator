...
namespace Rong.Volo.Abp.CodeGenerator.Vue.TemplateHelpers.Vben2
{
    ...
    /// vben模板 -  table查询表单
    /// </summary>
    public class RongVoloAbpVueVben2TemplateStringOfTableSchemas : RongVoloAbpVueTemplateBase, ISingletonDependency
    {

        public RongVoloAbpVueVben2TemplateStringOfTableSchemas(IOptions<RongVoloAbpCodeGeneratorVueOptions> options) : base(options)
        {
        }
