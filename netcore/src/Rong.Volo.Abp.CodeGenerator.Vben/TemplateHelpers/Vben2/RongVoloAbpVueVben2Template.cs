...
namespace Rong.Volo.Abp.CodeGenerator.Vue.TemplateHelpers.Vben2
{
    ...
    /// vben代码生成器帮助器
    /// </summary>
    [ExposeServices(typeof(IRongVoloAbpVueVbenTemplate),typeof(RongVoloAbpVueVben2Template))]
    public class RongVoloAbpVueVben2Template : IRongVoloAbpVueVbenTemplate
    {
        public VbenVersionEnum Version => VbenVersionEnum.Vben2;
        
        protected RongVoloAbpVueVben2TemplateStringOfForm FormTemplate;
        protected RongVoloAbpVueVben2TemplateStringOfTableColumns TableColumnsTemplate;
        protected RongVoloAbpVueVben2TemplateStringOfTableSchemas TableSchemasTemplate;
        protected RongVoloAbpVueVben2TemplateStringOfDetail DetailTemplate;

        public RongVoloAbpVueVben2Template(
            RongVoloAbpVueVben2TemplateStringOfForm form,
            RongVoloAbpVueVben2TemplateStringOfTableColumns tableColumnsTemplate,
            RongVoloAbpVueVben2TemplateStringOfTableSchemas tableSchemasTemplate,
            RongVoloAbpVueVben2TemplateStringOfDetail detailTemplate
        )
        {
            FormTemplate = form;
